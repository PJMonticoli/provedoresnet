...
Public Class RptImpresoComprobantePorTipoComp
    ...
    Private Sub Detail_Format(sender As Object, e As EventArgs) Handles Detail.Format
        ...
        Select Case Fields!TipoGrupo.Value
            ...
            Case 3, 6, 8, 10 '9
                ' si es de guma
                txtTotal.Text = Format(CDbl(txtTotal.Text) * -1, "#,##0.00")
                txtImpNI.Text = Format(CDbl(txtImpNI.Text) * -1, "#,##0.00")
                txtFIP.Text = Format(CDbl(txtFIP.Text) * -1, "#,##0.00")
                txtIvaProd.Text = Format(CDbl(txtIvaProd.Text) * -1, "#,##0.00")
                txtPerGan.Text = Format(CDbl(txtPerGan.Text) * -1, "#,##0.00")
                txtPerIB.Text = Format(CDbl(txtPerIB.Text) * -1, "#,##0.00")
                txtPerIVA.Text = Format(CDbl(txtPerIVA.Text) * -1, "#,##0.00")
        ...
        txtFIP.Text = Format(CDbl(txtFIP.Text), "N2")
        txtTotal.Text = Format(CDbl(txtTotal.Text), "N2")
        txtIvaProd.Text = Format(CDbl(txtIvaProd.Text), "N2")
        txtPerIVA.Text = Format(CDbl(txtPerIVA.Text), "N2")
        txtPerGan.Text = Format(CDbl(txtPerGan.Text), "N2")
        txtPerIB.Text = Format(CDbl(txtPerIB.Text), "N2")
        txtFIP.Text = Format(CDbl(txtFIP.Text), "N2")
