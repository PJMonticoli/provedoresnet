...
Public Class RptImpresoComprobantePorTipoCompPorInsumoExp
    ...
    Private Sub Detail_Format(sender As Object, e As EventArgs) Handles Detail.Format
        ...
        Select Case Fields!TipoGrupo.Value
            Case 1, 2
                ...
                '            totalni = totalni + Fields!ImporteNoImp
                '            TOTALGEN = TOTALGEN + Fields!TotalComprobante
                '            GrupoTOTALGEN = GrupoTOTALGEN + Fields!TotalComprobante
                If Fields!cotizacionDolar.Value = 0 Then
                    ' Manejar el caso cuando el denominador es cero
                    ' Puedes asignar un valor predeterminado o realizar alguna lógica específica
                    totalni = totalni + 0
                    TOTALGEN = TOTALGEN + 0
                    oTotal = 0
                    oCotizacion = Fields!cotizacionDolar.Value
                    GrupoTOTALGEN = GrupoTOTALGEN + Fields!TotalComprobante.Value / Fields!cotizacionDolar.Value
                Else
                    ' Realizar la operación de división normal si el denominador no es cero
                    totalni = totalni + Fields!ImporteNoImp.Value / Fields!cotizacionDolar.Value
                    TOTALGEN = TOTALGEN + Fields!TotalComprobante.Value / Fields!cotizacionDolar.Value
                    txtTotal.Text = Fields!TotalComprobante.Value / Fields!cotizacionDolar.Value
                    txtImpNI.Text = Fields!ImporteNoImp.Value / Fields!cotizacionDolar.Value
                    GrupoTOTALGEN = GrupoTOTALGEN + Fields!TotalComprobante.Value / Fields!cotizacionDolar.Value
                    oCotizacion = Fields!cotizacionDolar.Value
                End If
        'Creditos
            Case 3, 6, 8, 10
                ...
                If Not IsDBNull(Fields!cotizacionDolar.Value) AndAlso Convert.ToInt32(Fields!cotizacionDolar.Value) = 0 Then
         ...
         'Debitos
            Case 4, 5, 7, 9, 11
                If Fields!cotizacionDolar.Value = 0 Then
                    ...
                    oCotizacion = Fields!cotizacionDolar.Value
                Else
                    totalni = totalni + Fields!ImporteNoImp / Fields!cotizacionDolar.Value
                    TOTALGEN = TOTALGEN + Fields!TotalComprobante / Fields!cotizacionDolar.Value
                    txtTotal.Text = Fields!TotalComprobante.Value / Fields!cotizacionDolar.Value
                    GrupoTOTALGEN = GrupoTOTALGEN + Fields!TotalComprobante.Value / Fields!cotizacionDolar.Value
                    txtImpNI.Text = Fields!ImporteNoImp.Value / Fields!cotizacionDolar.Value
                    oCotizacion = Fields!cotizacionDolar.Value
        ...
        If tipoInsumoTotales.ContainsKey(tipoInsumoActual) Then
            Select Case Fields!TipoGrupo.Value
                Case 3, 8, 6, 10
                    ...
                    Else
                        tipoInsumoTotales(tipoInsumoActual) -= Convert.ToDouble(Fields!TotalComprobante.Value / Fields!cotizacionDolar.Value)
                    End If
        ...
        Else
            Select Case Fields!TipoGrupo.Value
                Case 3, 8, 6, 10
                    ...
                    Else
                        tipoInsumoTotales(tipoInsumoActual) = Convert.ToDouble(Fields!TotalComprobante.Value / Fields!cotizacionDolar.Value) * -1
                    End If
                Case Else
                    If Fields!cotizacionDolar.Value = 0 Then
                        tipoInsumoTotales(tipoInsumoActual) = (Convert.ToDouble(Fields!TotalComprobante.Value))
